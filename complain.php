      ...
      <div class="row row-content mt-4 mb-5 mx-0">
        ...
        <div class="mx-md-auto col-lg-8 col-md-11 col-12 px-0">
              ...
              <div class="mb-3 ml-lg-0 ml-md-0 ml-3">
                <a class="text-black" href="index.php">หน้าหลัก</a> > <label class="text-blue"> ข้อเสนอแนะ</label>
              </div>
              ...
              <div class="mb-lg-5 ml-lg-0 ml-md-0  px-md-0 px-3 align-sm-center align-md-center">
                <label>สามารถกรอกข้อเสนอแนะได้ทางช่องทางดานล่าง เราจะขอน้อมรับคำติดชมและข้อเสนอแนะไปปรับปรุงบริการให้ดียิ่ง ขึ้นไป</label>
              </div>
