      ...
      <div class="row row-content mt-4 mb-5 mx-0">
        ...
        <div class="mx-md-auto col-lg-8 col-md-11 col-12 px-0">
              ...
              <div class="mb-3 ml-lg-0 ml-md-0 ml-3">
                <a class="text-black" href="index.php">หน้าหลัก</a> > <label class="text-blue"> ลืมรหัสผ่าน</label>
              </div>
              ...
              <div class="mb-lg-5 ml-lg-0 ml-md-0  px-md-0 px-3 align-sm-center align-md-center">
                <label>โปรดกรอก E-mail เพื่อรีเซ็ทรหัสผ่าน</label>
              </div>


              <div class="col-lg-8 col-md-10 col-12 px-0 mx-lg-0 mx-auto d-lg-cblock d-block d-md-block">
                  ...
                  <div class="form-group row mx-0">
                    ...
                    <div class="ml-md-2 mx-auto col-lg-5 col-md-5 col-8 px-0">
                      <input type="email" class="form-control form-control-sm overide-w-1024" id="" placeholder="">
                    </div>
                  </div>
